import 'package:edut3c/screens/StationScreens.dart';
...
const List<Map<String, dynamic>> _components = [
  {'id': 1, 'componente': 'Fuente de Alimentación', 'route': 'psu'},
  {'id': 2, 'componente': 'Disco Duro / SSD',        'route': 'storage'},
  {'id': 3, 'componente': 'Memoria RAM',              'route': 'ram'},
  {'id': 4, 'componente': 'Tarjeta de Red / Wi-Fi',  'route': 'network'},
  {'id': 5, 'componente': 'Microprocesador (CPU)',    'route': 'cpu'},
  {'id': 6, 'componente': 'Módulo RAM',               'route': 'ram_module'},
  {'id': 7, 'componente': 'Cooler / Ventilador CPU',  'route': 'cooler'},
  {'id': 8, 'componente': 'Tarjeta Gráfica (GPU)',    'route': 'gpu'},
  {'id': 9, 'componente': 'Almacenamiento M.2',       'route': 'm2'},
];
...
class _MapArea extends StatelessWidget {
  ...
  void _showComponentSheet(
    ...
    showModalBottomSheet(
      ...
      builder: (_) => _ComponentSheet(componente: comp,), 
    );
  }
}
        ...
        children: [
          ...
          SizedBox(
            ...
            child: ElevatedButton(
              ...
              onPressed: () {
              final levelsData = hardwareComponents[componente["route"]];
                if (levelsData == null) {
  ScaffoldMessenger.of(context).showSnackBar(
    SnackBar(
      content: Text(
        "No existe data para ${componente["route"]}",
      ),
    ),
  );
  return;
