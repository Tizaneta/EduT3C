...
// función para el mensaje emergente, podes personalizarlo.
    ...
    return Container(
      ...
      child: Padding(
        ...
        child: Container(
          ...
          child: const Icon(
            Icons.smart_toy_outlined, // Robot de aprendizaje pero lo vamos a cambiar por el logo de la app.
      ...
      children: [
        ...
        Row(
          ...
          children: [
            ...
            GestureDetector(
              onTap: () {
                // TODO: Implementar backend con la screen de inicio de sesión.
